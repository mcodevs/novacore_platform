...
- [Qarz daftari modeli](references/qarz-daftari-modeli.md) — oy yopish olib tashlandi; qarz = hisobot xususiyati; «narx bor = qarz bor»; avans (P7); ADR-0015/0016. **2026-08-03 prodga chiqarildi.** To'lov ekranida bitta amal tugmasi qoldi (2026-08-04).
...
- [Mini App dizayn tizimi](references/miniapp-dizayn-tizimi.md) — bo'shliq shkalasi `--s-*` (yangi CSS shunga tayanadi); `.card label` va tugma-qator tuzoqlari; `.row` grid.
