...
T: dict[str, dict[str, str]] = {
    ...
    "help_reporter": {
        "uz": (
            "<b>Qanday ishlaydi</b>\n\n"
            "1️⃣ Mashina ustaxonaga keldi → <b>🚗 Mashina keldi</b>\n"
            "2️⃣ Bot ketma-ket so'raydi: raqam, foto, probeg, muammo\n"
            "3️⃣ Bajarilgan ishlarni va <b>o'z narxingizni</b> kiritasiz\n"
            "4️⃣ Ish tugadi → <b>🚙 Mashina ketdi</b>\n"
            "5️⃣ <b>📤 Yuborish</b> — hisobot adminga ketadi\n"
            "6️⃣ Admin narxni kamaytirsa — sizga xabar keladi, "
            "<b>✅ Roziman</b> yoki <b>❌ Rozi emasman</b>\n\n"
            "⏱ 48 soat javob bermasangiz — avtomatik rozilik hisoblanadi.\n\n"
            "<b>Buyruqlar:</b>\n"
            "/yangi — yangi hisobot\n/mening — hisobotlarim\n/hisob — bu oygi summa\n"
            "/kelishuv — javob kutayotgan takliflar\n/til — til\n/yordam — shu matn"
        ),
        "ru": (
            "<b>Как это работает</b>\n\n"
            "1️⃣ Машина приехала → <b>🚗 Машина приехала</b>\n"
            "2️⃣ Бот спросит по шагам: номер, фото, пробег, проблема\n"
            "3️⃣ Вносите выполненные работы и <b>свою цену</b>\n"
            "4️⃣ Работа окончена → <b>🚙 Машина уехала</b>\n"
            "5️⃣ <b>📤 Отправить</b> — отчёт уходит администратору\n"
            "6️⃣ Если админ снизит цену — придёт уведомление: "
            "<b>✅ Согласен</b> или <b>❌ Не согласен</b>\n\n"
            "⏱ Без ответа 48 часов — согласие засчитывается автоматически.\n\n"
            "<b>Команды:</b>\n"
            "/yangi — новый отчёт\n/mening — мои отчёты\n/hisob — сумма за месяц\n"
            "/kelishuv — ожидающие предложения\n/til — язык\n/yordam — эта справка"
        ),
    },
    "help_admin": {
        "uz": (
            "<b>Admin imkoniyatlari</b>\n\n"
            "/tasdiq — tasdiq kutayotgan hisobotlar\n"
            "/kunlik — bugungi qisqa hisobot\n"
            "/davr — joriy davr va oyni yopish\n"
            "/eksport — Excel eksport\n\n"
            "Hisobot kartochkasida: ✅ tasdiqlash · ✏️ narxni kamaytirish (sabab majburiy) "
            "· ↩️ qaytarish · ❌ rad etish.\n\n"
            "⚠️ Narxni <b>faqat kamaytirish</b> mumkin (R2). O'z hisobotingiz "
            "avtomatik tasdiqlanadi (R1a).\n\n"
            "Siz ham hisobot yozishingiz mumkin: <b>🚗 Mashina keldi</b>."
        ),
        "ru": (
            "<b>Возможности администратора</b>\n\n"
            "/tasdiq — отчёты, ожидающие подтверждения\n"
            "/kunlik — краткий отчёт за сегодня\n"
            "/davr — текущий период и закрытие месяца\n"
            "/eksport — экспорт в Excel\n\n"
            "В карточке отчёта: ✅ подтвердить · ✏️ снизить цену (причина обязательна) "
            "· ↩️ вернуть · ❌ отклонить.\n\n"
            "⚠️ Цену можно <b>только снижать</b> (R2). Ваш собственный отчёт "
            "подтверждается автоматически (R1a).\n\n"
            "Вы тоже можете создать отчёт: <b>🚗 Машина приехала</b>."
        ),
    },
    "help_accountant": {
        "uz": (
            "<b>Buxgalter imkoniyatlari</b>\n\n"
            "/davr — davrlar, precheck va oyni yopish\n"
            "/eksport — to'lov varaqalari va hisobotlar (Excel)\n"
            "/kunlik — bugungi qisqa hisobot"
        ),
        "ru": (
            "<b>Возможности бухгалтера</b>\n\n"
            "/davr — периоды, проверка и закрытие месяца\n"
            "/eksport — ведомости и отчёты (Excel)\n"
            "/kunlik — краткий отчёт за сегодня"
        ),
    },
    # --- Hisobot yaratish ---
